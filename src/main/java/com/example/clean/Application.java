...
public class Application extends javafx.application.Application {
    ...
    public void start(Stage stage) {
        Image ico = new Image(String.valueOf(getClass().getResource("img/clean.png")));
        try {
            Parent root = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("clear.fxml")));
